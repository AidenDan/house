...
public interface HouseMapper extends Mapper<House> {
    ...
    List<HouseMoreInfo> selectAllHouse(@Param("userId") Integer userId);
    ...
    HouseMoreInfo selectHouseByHouseId(@Param("houseId") String houseId);
    ...
    List<HouseMoreInfo> selectAllHouse2(UsersCondition condition);
    ...
    List<HouseMoreInfo> selectAllHouse3(UsersCondition condition);
    ...
    List<HouseMoreInfo> selectAllHouse4(UsersCondition condition);
    ...
    @Select("<script>select house.ID, house.USER_ID userId, TITLE, DESCRIPTION, PRICE, PUBDATE, FLOORAGE, ispass, isdel, TYPE_ID typeId, STREET_ID streetId, street.DISTRICT_ID districtId," +
            ...
            "      </if> " +
            " and ispass =1 order by PUBDATE desc</script>")
    List<HouseMoreInfo> selectAllHouse5(UsersCondition condition);
    ...
    HouseMoreInfo selectSingleHouse(String houseId);
}
